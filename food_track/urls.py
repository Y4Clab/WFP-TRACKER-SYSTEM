...
urlpatterns += [
    ...
    path('vendor-data/<int:vendor_id>/', VendorDataByIdView.as_view(), name='vendor-data-by-id'),
    
    # Vendor-specific resource views
    # Trucks
    path('vendor/trucks/', VendorTruckListCreateView.as_view(), name='vendor-trucks-list-create'),
    path('vendor/trucks/<int:truck_id>/', VendorTruckDetailView.as_view(), name='vendor-truck-detail'),
    
    # Contacts
    path('vendor/contacts/', VendorContactListCreateView.as_view(), name='vendor-contacts-list-create'),
    path('vendor/contacts/<int:contact_id>/', VendorContactDetailView.as_view(), name='vendor-contact-detail'),
    
    # Missions
    path('vendor/missions/', VendorMissionListView.as_view(), name='vendor-missions-list'),
    path('vendor/missions/<int:mission_id>/', VendorMissionDetailView.as_view(), name='vendor-mission-detail'),
